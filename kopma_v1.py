...
img_filename1 = PhotoImage(file=r'C:\\Users\\saone\\Documents\\GitHub\basic_tkd_scoreboards\\bg_image.png')
background_label1 = Label(tab1, image=img_filename1)
background_label1.place(x=0, y=0, relwidth=1, relheight=1)
C1.pack()
C2 = Canvas(tab2, bg="white", height=window_width, width=window_width)
img_filename2 = PhotoImage(file=r'C:\\Users\\saone\\Documents\\GitHub\basic_tkd_scoreboards\\bg_image.png')
background_label2 = Label(tab2, image=img_filename2)
background_label2.place(x=0, y=0, relwidth=1, relheight=1)
C2.pack()
C3 = Canvas(tab3, bg="white", height=window_width, width=window_width)
img_filename3 = PhotoImage(file=r'C:\\Users\\saone\\Documents\\GitHub\basic_tkd_scoreboards\\bg_image - kumite.png')
