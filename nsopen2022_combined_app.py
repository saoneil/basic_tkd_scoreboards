...
class MainApplication(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        pattern_string = "          "
        pattern_label = tk.Label(tab1, text=pattern_string, font = "Verdana 180 bold", bg = "white")
        ...
        time_label = tk.Label(tab2, text="Ready", bg='black', fg="white", font="Verdana 130 bold")
        ...
        label_red_warnings = tk.Label(tab2, text=red_warnings, font='Verdana 200 bold', bg='black', fg='white')
        label_red_fouls = tk.Label(tab2, text=red_fouls, font='Verdana 150 bold', bg='black', fg='white')
        label_blue_warnings = tk.Label(tab2, text=blue_warnings, font='Verdana 200 bold', bg='black', fg='white')
        ...
        redwarninc = tk.Button(tab2, text="redwarning+", font='Verdana 5 bold', command=warn_red_inc, width=15, height=4)
        redwarndec = tk.Button(tab2, text="redwarning-", font='Verdana 5 bold', command=warn_red_dec, width=15, height=4)
        redfoulinc = tk.Button(tab2, text="redfoul+", font='Verdana 5 bold', command=red_foul_inc, width=15, height=4)
        redfouldec = tk.Button(tab2, text="redfoul-", font='Verdana 5 bold', command=red_foul_dec, width=15, height=4)
        bluewarninc = tk.Button(tab2, text="bluewarning+", font='Verdana 5 bold', command=warn_blue_inc, width=15, height=4)
        bluewarndec = tk.Button(tab2, text="bluewarning-", font='Verdana 5 bold', command=warn_blue_dec, width=15, height=4)
        bluefoulinc = tk.Button(tab2, text="bluefoul+", font='Verdana 5 bold', command=blue_foul_inc, width=15, height=4)
        bluefouldec = tk.Button(tab2, text="bluefoul-", font='Verdana 5 bold', command=blue_foul_dec, width=15, height=4)
        roundcounterinc = tk.Button(tab2, text="round+", font='Verdana 5 bold', command=round_counter_inc, width=15, height=4)
        roundcounterdec = tk.Button(tab2, text="round-", font='Verdana 5 bold', command=round_counter_dec, width=15, height=4)
        reset_all = tk.Button(tab2, text='Reset Scores', command=reset_all, width=15)

        time_label.grid(row=1, column=1, columnspan=5)
        start.grid(row=6, column=3)
        stop.grid(row=7, column=3)
        reset.grid(row=8, column=3)
        reset_all.grid(row=9, column=3)

        label_red_warnings.grid(row=3, column=2)
        label_red_fouls.grid(row=3, column=1)
        label_blue_warnings.grid(row=3, column=4)
        label_blue_fouls.grid(row=3, column=5)
        label_round_counter.grid(row=3, column=3)
