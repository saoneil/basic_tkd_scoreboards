...
roundcounterinc = tk.Button(root, text="round+", font='Verdana 5 bold', command=round_counter_inc, width=9, height=1)
roundcounterdec = tk.Button(root, text="round-", font='Verdana 5 bold', command=round_counter_dec, width=9, height=1)
...
rw.place(relx=0.22, rely=0.20)
rf.place(relx=0.07, rely=0.24)
bw.place(relx=0.78, rely=0.20)
bf.place(relx=0.93, rely=0.24)
round.place(relx=0.50, rely=0.32)

redwarninc.place(relx=0.22, rely=0.26)
redwarndec.place(relx=0.22, rely=0.62)
redfoulinc.place(relx=0.07, rely=0.30)
redfouldec.place(relx=0.07, rely=0.55)
bluewarninc.place(relx=0.78, rely=0.26)
bluewarndec.place(relx=0.78, rely=0.62)
bluefoulinc.place(relx=0.93, rely=0.30)
bluefouldec.place(relx=0.93, rely=0.55)
roundcounterinc.place(relx=0.5, rely=0.4)
roundcounterdec.place(relx=0.5, rely=0.55)
